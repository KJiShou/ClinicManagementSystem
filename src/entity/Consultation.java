...
public class Consultation {
    ...
    public Consultation(UUID id, Patient patient, Doctor doctor, LocalDate consultatonDate, String status, String notes, LocalTime startTime, LocalTime endTime, float totalPayment) {
        this.id = id;
